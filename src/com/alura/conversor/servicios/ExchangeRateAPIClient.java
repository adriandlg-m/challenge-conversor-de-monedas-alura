...
public class ExchangeRateAPIClient {
    ...
    static {
        ...
        try (FileInputStream fis = new FileInputStream("resources/config.properties")) {
            ...
            CLAVE_API = propiedades.getProperty("apiKey");
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }

    public Tasas resultadoDeConversion (String baseCode, String targetCode, double amount) throws IOException, InterruptedException {
        ...
        return new Gson().fromJson(respuesta.body(), Tasas.class);
    }
}
